...
export default function Toast() {
  ...
  return (
    <div
      ref={toastRef}
      className={`${toastState ? "bg-green-500" : "bg-red-400"} rounded-md [box-shadow:1px_2px_4px_2px_black] w-3/4 h-18  fixed top-4/5 left-0 right-0 m-auto p-2 flex items-center gap-2 animate-notificacionEntrada`}
    >
